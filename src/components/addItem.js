...
handleChange = name => event => {
    ...
    console.log("Name: " + this.state.itemName + " Price: £" 
    + this.state.itemPrice + " Description:" + this.state.itemDescription);
  };
...
handleSubmit = (e) => {
    ...
    API.graphql(graphqlOperation(mutations.createTodo, {input: itemDetails}));
}
